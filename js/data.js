 ...
 var poi = [
	{
		...
		"infoContent":	"<p>The charming, quirky and distinctive areas of the lanes are separated into two areas.</p><p>The North Laine is a central row of streets of small quirky one off stores, niche cafes and bars, stretching north within a grid like layout of residential streets patched with other occasional shops.</p><p>The lanes, also known as the south lanes, is a tangled web of narrow lanes with small stores and hidden squares. It has a high population of antique jewellery shops, high end fashion retailers, and is buzzing with all kinds of restaurants and bars.</p><p>Both areas boast a changeable selection of performers and street merchants, creating a curious and enjoyable shopping experience.</p>",
		"locations": [
			{
	...
	// 			],
	// 	"infoContent": "<div class='row'><div class='col-sm-6'><p>The beach in the city or Brighton and Hove ranges from busy and buzzing around the centre, between the 2 piers, to a more restful and spacious vibe at the two ends. The west side, heading up towards hove lagoon brings a distinct family feel with its iconic beach huts, and free range children. The east side of the palace pier hosts a slightly more hip and racey crowd. Situated just south of the gay friendly area of kemptown it leads up towards the infamous nudist beach on the way to the marina.</p><p>The markers in this section are all based on Phil Lucas's comedy observations of the stereotypes of people you find in different areas of the beach on a sunny day. You can see the main part of his 2017 comedy illustration, which he updates annually, displayed in this information section.</p></div><div class='col-sm-6'><img src='img/seafront/where-to-sit.jpg' alt='comedy image of where to sit on Brighton Beach' width=100%><p>attribution: <a href='https://www.phillucas.com/single-post/2014/10/16/Know-Where-to-Sit-on-Brighton-Beach'>Phil Lucas - Comedian</a></p></div></div>",
	// 	"locations": [
	// 		{
	...
	// },
	{
		...
		"infoContent": "<p>Brighton has a diverse, quirky and charming range of landmarks both historic and modern. The elaborate Brighton Pavilion, Indian style on the outside, Chinese style on the inside, sets the scene for the ecclectic mishmash of the city that has grown up around it. One of its crowning moments for me was the Dr Blighty light show in Brighton festival 2016 where the whole building was lit up in a spectacular fashion using a stunning colour palette as diverse as Brighton itself. You can see a picture of one of the light formations when you click on the landmark marker.</p><p>On our vibrant city coast line there are a number of diverse landmarks: the two distinctive and quirky piers stretching out into the English Channel, the historic and recently beautifully refurbished bandstand, and the brand new shiny, but locally controversial i360 tower - the tallest structure in Sussex and in the Guinness book of world records as being the world most slender tower.</p><p>The Brighton wheel, the charming tourist attraction east of the pier was sadly dismantled on the opening of the i360, compounding the controversy surrounding Brightons newest landmark. I have included the Brighton wheel in this section on landmarks because frankly, we miss it a little bit!</p>",
		"locations": [
			{
	...
	},
	{
		...
		"infoContent": "<p>Brighton, nestled within the South Downs on the south coast of England, has its own little microclimate, making it one of the sunniest locations within the U.K.</p><p>The South Downs stretching for 100 kilometers from Eastbourne to Winchester boast some beautiful scenery of stunning rolling hills and grassy peaks. The highest point in the South Downs at Ditchling beacon has views which stretch over 50miles in every direction.</p><p>Just a couple of miles outside of the suburbs of Brighton the Downs are the perfect antidote to city life, and and afternoon escape which can make you feel a million miles away from civilisation even although geographically they are highly accessible.</p>",
		"locations": [
			{
				"name": "Devils Dyke",
